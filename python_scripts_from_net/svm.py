...
def create_features(XX, tmin, tmax, sfreq, tmin_original=-0.5):
    ...
    XX -= XX.mean(0)
   # XX = np.nan_to_num(XX / XX.std(0))			#Sank
...
if __name__ == '__main__':
    ...
    print
    subjects_train = [1, 7, 8, 13, 15, 5, 3, 10, 2,  12, 14, 11,  16] # use range(1, 17) for all subjects
    ...
    for subject in subjects_train:
        filename = '/home/sank/Desktop/neuro/data/train/train_subject%02d.mat' % subject
    ...
    if(resfile != ''):
        ...
        for subject in subjects_test:
            filename = '/home/sank/Desktop/neuro/data/test/test_subject%02d.mat' % subject
            print "Loading", filename
            data = loadmat(filename, squeeze_me=True)
            XX = data['X']
            ids = data['Id']
